...
### R14. Tablero dual rectangular 7×5 pointy 35 [v2.13] (modifica R6.2, R8)
- `R14.1` — Tablero SIEMPRE dibujado completo: RECTÁNGULO pointy de **5 filas axiales × 7 celdas = 35 [v2.13]** (v2.12 y antes: 4×8=32). Contorno rectangular tipo marco de Catan con offset de panal; en columna plegada `q+floor(r/2)` las 5 filas comparten patrón consecutivo -3..3. No jugable = visible apagada (estilo lock). (v2.0/v2.1: panal [7,9,9,7], reemplazado.)
