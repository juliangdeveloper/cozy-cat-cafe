...
// ---------------------------------------------------------------------------
test('T13a [R13.3] openRun: rosterIndex 5, pool 1..colorsOwned, board 36, 7 jugables', () => {
  ...
  // tablero dual 36 celdas (R14.1 v2.14) — núcleo 2-3-2 jugable (R14.2)
  assert.ok(Array.isArray(run.board), 'RED: run.board debe ser array');
  assert.equal(run.board.length, 36, 'RED: el board de run v2.14 tiene 36 celdas [R14.1]'); // v2.14-shape: 35 → 36 (rectángulo 6×6)
